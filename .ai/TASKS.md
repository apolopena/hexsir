...
MAINT-23: `rerw write savefile item swap|add|remove` CLI subcommands (2026-05-01)
  ...
  - Updated `rw/key-findings/magical-objects.md` "Tooling" section to reflect that the lib + CLI are wired; supersedes the prior "not yet wired" status.
