...
**Status:** partial / in-flight. Observations confirmed; field interpretation hypothesized. Not yet promoted from observation to verified semantics.
**Created:** 2026-04-29
...
- `rw/key-findings/item-table.md` — for cross-referencing catalog GUIDs to item attributes.
- `rw/key-findings/save-binary-format.md` — for record format conventions and the type-registry mention of `ObjectCollectionUnlockConditionData`.
