...
**Status:** Resolved 2026-04-29. Save format itself is fully account-agnostic; the apparent cross-account lock is Steam Cloud sync overwriting local files at launch/quit, not any check inside the game.
**Created:** 2026-04-29
