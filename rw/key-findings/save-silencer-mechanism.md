...
- `rw/key-findings/save-subsystem.md` — full save subsystem RE; this finding extends the "open question" on `+0x1ef4` listed there.
- `rw/triage/save-event-not-firing.md` — the observation triage; this doc supersedes both hypotheses (mis-click, game-lies). The mechanism is structural.
