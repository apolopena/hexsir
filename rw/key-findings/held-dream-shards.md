...
**Status:** active reference. Verified in lab 2026-05-01.
...
Lab promotion record: `rw/saves/edits/golden/geppetto/chapter1/held-shards-99__from-mint__from-chapter3-laser_lenses_1-proof/breakthrough.md`.

## Related

- `save-edit-pipeline-2026-04-30.md` — full HC body schema and the broader save-edit pipeline.
