...
**Status:** active reference. Source data extracted from the deciphered asset tree.
**Created:** 2026-04-27
...
- `rw/key-findings/save-binary-format.md` — record format details + verification status.
