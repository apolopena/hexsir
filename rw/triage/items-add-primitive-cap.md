...
- rw/key-findings/magical-objects.md (canonical doc; engine-validation section needs revision after this triage)
...
- rw/triage/ghidra-rule-c-investigation.md (companion Ghidra dive — call chain, function renames, narrowing of Rule C)
...
Full call-chain trace, function renames, remaining unknowns, and suggested next-session probes: see `rw/triage/ghidra-rule-c-investigation.md`.
