...
- rw/key-findings/oe-dynamic-listener-data.md (the doc whose pinned addresses are the subject of this triage)
- rw/triage/live-state-mirror-cascade.md (substantive observations from this session)
...
`rw/triage/live-state-mirror-cascade.md`.
...
`rw/triage/live-state-mirror-cascade.md` documents what we *observed*
