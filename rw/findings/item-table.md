...
**Status:** confirmed
**Status notes:** active reference. Source data extracted from the cooked Steam install (`DarkTalesResources/_Cooking/MzidisFqiidzyv/Oacqbiv/`, deciphered: `EntitySettings/Obzects/`) cross-checked against `tag=0x05` catalog records in clean save.
**Created:** 2026-04-29
