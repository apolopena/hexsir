...
plausible but unverified. See `rw/findings/pin-identity-uncertain.md` for
...
- HP-current pin doesn't move on damage events: HP is computed; the listener
  ...
  see `rw/findings/pin-identity-uncertain.md`.)
...
this doc and `rw/findings/pin-identity-uncertain.md` for the open
hypotheses.
...
- **Stars of fate** — found as a **plain int32** in the player struct at
  ...
  **Verified 2026-04-26 to also not be live:** HUD spent 4 → 3, the pin
  ...
  `rw/findings/pin-identity-uncertain.md`. Player has confirmed similar
...
- rw/findings/level-runtime-address.md
