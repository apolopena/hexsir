...
> **ARCHIVED 2026-05-03** — geppetto save analysis promoted to per-domain findings.
> Almost entirely promoted to per-domain findings — see [`talent-records.md`](talent-records.md), [`magical-objects.md`](magical-objects.md), [`save-binary-format.md`](save-binary-format.md), and [`save-edit-pipeline.md`](save-edit-pipeline.md).
...
- **CRC32 location, save body offset, header structure** → `rw/findings/save-binary-format.md` and `rw/findings/save-edit-pipeline.md`
