...
> **ARCHIVED 2026-05-03** — live-state mirror cascade folded into OE listener finding.
> Folded into [`oe-dynamic-listener-data.md`](oe-dynamic-listener-data.md). The cascade behavior is part of the broader OE listener-data architecture documented there.
...
- rw/findings/oe-dynamic-listener-data.md (existing key-findings doc; updated this session with the cascade findings — most confirmed content has been folded in there directly)
...
> discriminating tests see `rw/findings/pin-identity-uncertain.md`. The
