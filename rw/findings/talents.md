...
**Status:** confirmed
**Status notes:** partial; expanded as new saves / experiments surface more names.
**Created:** 2026-04-27
...
- Hero-swap experiments documented in `rw/findings/hero-swaps.md` — Carmilla / Aladdin / Snow_Queen / Red ult observations.
