...
> **ARCHIVED 2026-05-03** — decoder work tasks complete.
> Tasks complete; the decoder/encoder pipeline shipped as `tools/rerw-src/lib/cooked.py`. Pipeline-level details and the recipe inventory live in [`save-edit-pipeline.md`](save-edit-pipeline.md).
