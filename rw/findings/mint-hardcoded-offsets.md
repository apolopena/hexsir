...
> **ARCHIVED 2026-05-03** — mint hardcoded offsets resolved.
> Resolved 2026-05-01 by `tools/rerw-src/lib/hc_walker.py` (commit `52cff33`). The walker resolves named HC body offsets dynamically; production mint no longer assumes chapter-2 layout.
...
- `rw/findings/save-subsystem.md` — save subsystem RE
- `rw/findings/save-edit-pipeline.md` — wire-format references
- `rw/findings/save-silencer-mechanism.md` — context for why deserialize failure trips the silencer
