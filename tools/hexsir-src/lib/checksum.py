...
def analyze_region(data: bytes, label: str) -> list[tuple[str, str]]:
    ...
    """
    from display_lib.output import header
    ...
    print_checksum_results("4-byte checksum at beginning", begin_results)
    print_checksum_results("4-byte checksum at end", end_results)
